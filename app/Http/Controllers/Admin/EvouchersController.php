...
class EvouchersController extends Controller
{

    private $method = 'e-vouchers';

    private $folder = 'evouchers';

    private $redirectRoute = 'admin_evouchers';
