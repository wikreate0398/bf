...
<div class="content">
    ...
    <form class="login-form ajax__submit" action="{{ route('admin_run_login') }}" method="post">
        ...
        <h3 class="form-title" style="text-align:center;">Authorization</h3>
        @if ($errors->has('login'))
            <div class="alert alert-danger">{{ $errors->first('login') }}</div>
        @endif
        <div class="form-group">
            <!--ie8, ie9 does not support html5 placeholder, so we just show field title for that-->
            <label class="control-label-ie8 visible-ie9">Login</label>
            <div class="input-icon">
                <i class="fa fa-user"></i>
                <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Login" required name="email"/>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="input-icon">
                ...
                <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Password" required name="password"/>
            </div>
        </div>
